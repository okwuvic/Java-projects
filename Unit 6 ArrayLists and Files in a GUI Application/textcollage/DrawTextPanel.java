...
//		s.setBackgroundTransparency(0.7);  // Default is 0, meaning background is not transparent.
	...
	private void doMenuCommand(String command) {
		...
		/*
		 * This is the additional feature of my program and works when the user presses
		 * the button "Draw Random Collage". It reads a plain text file and displays a
		 * random collage containing those texts in different colors, size and
		 * orientation
		 */
